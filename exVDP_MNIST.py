...
def main_function(input_dim=28, num_kernels=[32], kernels_size=[5], maxpooling_size=[2], maxpooling_stride=[2], maxpooling_pad='SAME', class_num=10 , batch_size=100,
        ...
        Random_noise=False, gaussain_noise_std=0.5, Adversarial_noise=False, epsilon = 0.1,corrupted_images=False,kind="Impulse", adversary_target_cls=3, Targeted=False, Testing_F=True,
...
#                       }) 
    ...
    if (Testing_F):
        ...
        pickle.dump([correct_classification, misclassification_true, pred_var], pf)                                            pf.close()   
...
if __name__ == '__main__':
    main_function()#Testing=True)#random_noise=True, gaussian_std=0.1)
   # main_function(random_noise=True, gaussian_std=0.2)
  #  main_function()
   # main_function()
  # main_function()