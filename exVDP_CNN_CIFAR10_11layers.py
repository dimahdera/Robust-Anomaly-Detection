...
def main_function(input_dim=32, n_channel=3, num_kernels=[32, 32, 32, 32, 64, 64, 64, 128, 128, 128],
                  ...
                  batch_size=50, epochs=350, lr=0.0002, lr_end = 0.0001, kl_factor=0.00001, Testing_SV=True,
                  Random_noise=False, Adversarial_noise=False, HCV=0.01,   Black_box_attack=False, PGDBlack_box_attack=False, 
                  adversary_target_cls=3, Targeted=False,corrupted_images=False,kind="brightness", PGD_Adversarial_noise=False, stepSize=1, maxAdvStep=40,
                  Training=False, Testing = False, continue_training=False, saved_model_epochs=300):
    PATH = './VDP_CNN_c10/saved_models/VDP_cnn_epoch_{}/'.format(epochs)
    ...
    if Training: 
       # wandb.init(entity = "dimah", project="VDP_CNN_Cifar10_11layers_epochs_{}_lr_{}_github".format(epochs, lr)) 
        if continue_training:
            saved_model_path = './VDP_CNN_c10/saved_models/VDP_cnn_epoch_{}/'.format(saved_model_epochs)
...
#    main_function(Random_noise=True, Adversarial_noise=False, HCV=0.05)
#    main_function(Random_noise=True, Adversarial_noise=False, HCV=0.1)
    #main_function(Testing = True)
    
    
#    main_function(Random_noise=True, HCV=0.01)
#    main_function(Random_noise=True, HCV=0.02)
#    main_function(Random_noise=True, HCV=0.03)
#    main_function(Random_noise=True, HCV=0.04)
#    main_function(Random_noise=True, HCV=0.045)
#    main_function(Random_noise=True, HCV=0.06)
 #   main_function(Random_noise=True, HCV=0.2)
  #  main_function(Random_noise=True, HCV=0.3)
  #  main_function(Random_noise=True, HCV=0.4)
   # main_function(Random_noise=True, HCV=0.5)
  
    
    #main_function(Random_noise=False, Adversarial_noise=True,Targeted=False, HCV=0.01)
#    main_function(Random_noise=False, Adversarial_noise=True,Targeted=False, HCV=0.02)
#    main_function(Random_noise=False, Adversarial_noise=True,Targeted=False, HCV=0.03)
#    main_function(Random_noise=False, Adversarial_noise=True,Targeted=False, HCV=0.04)
#    main_function(Random_noise=False, Adversarial_noise=True,Targeted=False, HCV=0.045)
    #main_function(Random_noise=False, Adversarial_noise=True,Targeted=False, HCV=0.06)
    #main_function(Random_noise=False, Adversarial_noise=True,Targeted=False, HCV=0.1)